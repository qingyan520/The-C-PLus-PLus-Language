...
![image-20210917211123582](https://raw.githubusercontent.com/qingyan520/Cloud_img/master/img/image-20210917211123582.png)
...
#### [10_7_434. 字符串中的单词数](https://leetcode-cn.com/problems/number-of-segments-in-a-string/)
...
> 思路：直接在末尾添加一个空格，然后统计整个字符串中空格的个数即可
...
#### [11_4_367. 有效的完全平方数](https://leetcode-cn.com/problems/valid-perfect-square/)
...
> 思路：首先这里涉及到一个数学问题：n^2=1+3+5+7+9……+2n-1=n*(1+2n-1)/2=n^2,那么题目就变得简单多了，一直从一开始减奇数，到最后判断是否为0即可
